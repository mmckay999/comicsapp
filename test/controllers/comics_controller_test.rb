...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { issue: @comic.issue, publisher: @comic.publisher, title: @comic.title } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { issue: @comic.issue, publisher: @comic.publisher, title: @comic.title } }
